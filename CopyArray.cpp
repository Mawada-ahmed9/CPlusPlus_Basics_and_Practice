...
void CopyArray(int array[100], int array2[100], int number){
    for(int i =0; i < number; i++){
        AddArrayElement(array[i],array2,i);
    }
}
...
int main (){
    ...
    int array[100], number = ReadPositiveNumber("enter your massge "), array2[100];

    FillArray(array, number);
    cout << "Array 1 elements: " endl<<;
    PrintArray(array, number);

    CopyArray(array, array2, number);
